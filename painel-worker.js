...
<div class="app">
  ...
  <aside class="rail">
    ...
    <nav class="nav" id="nav">
      <button data-tela="baralho" data-arc="✦">
        <svg viewBox="0 0 24 24"><rect x="4" y="3" width="11" height="16" rx="1.5"/><path d="M9 7l1.2 3.4L13.6 9l-2 3 2 3-3.4-1.4L9 17l-1.2-3.4L4.4 15l2-3-2-3L7.8 10.4z" fill="none"/></svg><span>O baralho</span>
      </button>
