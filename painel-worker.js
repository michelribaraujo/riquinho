...
.heroi .val{font-size:var(--t-heroi);font-weight:600;line-height:1.02;margin:6px 0 10px}
...
.cel .val{font-size:var(--t-num);font-weight:600;letter-spacing:-.02em;margin-top:6px;line-height:1.1;white-space:nowrap}
...
function recalcular(){
  ...
  /* SALDO PROJETADO DIA A DIA (30 dias) */
...
function renderMes(){
  ...
  faixa(el("mFaixa"), [
    ...
    { rot:"Menor saldo previsto", val:C(menorSaldo().saldo), pe:menorSaldo().data.slice(8,10)+"/"+menorSaldo().data.slice(5,7),
      cls: menorSaldo().saldo < 0 ? "ruim" : "" }
  ]);
